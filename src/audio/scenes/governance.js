...
export const governanceScene = {
  ...
  mood: {
    ...
    melodicMaterial: {
      ...
      slideCells: [
      [
        { note: 'A3', dur: '2n.', vel: 0.12 },
        { note: 'F#3', dur: '8n', vel: 0.12 },
        { note: 'G#3', dur: '4n', vel: 0.12 },
        { note: 'A3', dur: '8n', vel: 0.12 },
        { note: 'C#4', dur: '2n', vel: 0.12 },
        { note: 'B3', dur: '8n', vel: 0.12 },
        { note: 'A3', dur: '4n', vel: 0.12 },
        { note: 'F#3', dur: '8n', vel: 0.12 },
        { note: 'A3', dur: '2n.', vel: 0.08 },
        { note: 'F#3', dur: '8n', vel: 0.08 },
        { note: 'G#3', dur: '4n', vel: 0.08 },
    ...
    harmonicaCells: [
      [
        { note: 'C#4', dur: '2n.', vel: 0.12 },
        { note: 'F#4', dur: '8n', vel: 0.12 },
        { note: 'A4', dur: '4n', vel: 0.12 },
        { note: 'E5', dur: '8n', vel: 0.12 },
        { note: 'C#5', dur: '2n', vel: 0.12 },
        { note: 'B4', dur: '8n', vel: 0.12 },
        { note: 'A4', dur: '4n', vel: 0.12 },
        { note: 'F#4', dur: '8n', vel: 0.12 },
        { note: 'C#4', dur: '2n.', vel: 0.08 },
        { note: 'F#4', dur: '8n', vel: 0.08 },
        { note: 'A4', dur: '4n', vel: 0.08 },
        { note: 'E5', dur: '8n', vel: 0.08 },
        { note: 'C#5', dur: '2n', vel: 0.08 },
